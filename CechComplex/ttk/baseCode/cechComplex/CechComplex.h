/// \ingroup baseCode
/// \class ttk::CechComplex 
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// \brief TTK %cechComplex processing package.
///
/// %CechComplex is a TTK processing package that takes a scalar field on the input 
/// and produces a scalar field on the output.
///
/// \sa ttk::Triangulation
/// \sa vtkCechComplex.cpp %for a usage example.

#ifndef _CECHCOMPLEX_H
#define _CECHCOMPLEX_H
...
namespace ttk{
  ...
  class CechComplex : public Debug{
    ...
    public:
      ...
      /// see the setInput*() functions of ttk::Triangulation). See vtkCechComplex 
...
// #include                  <CechComplex.cpp>

// template functions
template <class dataType> int CechComplex::execute(
...
#pragma omp parallel for num_threads(threadNumber_) 
  ...
  {
    stringstream msg;
    msg << "[CechComplex] Data-set (" << vertexNumber
      << " points) processed in "
