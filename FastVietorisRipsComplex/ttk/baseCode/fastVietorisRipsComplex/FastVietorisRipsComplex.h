/// \ingroup baseCode
/// \class ttk::FastVietorisRipsComplex 
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// \brief TTK %fastVietorisRipsComplex processing package.
///
/// %FastVietorisRipsComplex is a TTK processing package that takes a scalar field on the input 
/// and produces a scalar field on the output.
///
/// \sa ttk::Triangulation
/// \sa vtkFastVietorisRipsComplex.cpp %for a usage example.

#ifndef _FASTVIETORISRIPSCOMPLEX_H
#define _FASTVIETORISRIPSCOMPLEX_H
...
namespace ttk{
  ...
  class FastVietorisRipsComplex : public Debug{
    ...
    public:
      ...
      /// see the setInput*() functions of ttk::Triangulation). See vtkFastVietorisRipsComplex 
...
// #include                  <FastVietorisRipsComplex.cpp>

// template functions
template <class dataType> int FastVietorisRipsComplex::execute(
...
#pragma omp parallel for num_threads(threadNumber_) 
  ...
  {
    stringstream msg;
    msg << "[FastVietorisRipsComplex] Data-set (" << vertexNumber
      << " points) processed in "
...
#endif // FASTVIETORISRIPSCOMPLEX_H
